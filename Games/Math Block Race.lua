-- GAME LINK: https://www.roblox.com/games/14656843302/FREE-UGC-Math-Block-Race
-- UI LIBRARY
...
Tab:Button{
	...
	Description = nil,
	Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/0MathBlock"))()
    end
}
-- CREDITS
GUI:Credit{
