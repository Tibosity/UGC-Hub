-- GAME LINK: https://www.roblox.com/games/13978342818/FREE-UGC-ESCAPE-GORDAN-RAMSAY
-- UI LIBRARY
...
Tab:Button{
	...
	Description = nil,
	Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/0EscapeGordan"))()
    end
}
-- CREDITS
GUI:Credit{
