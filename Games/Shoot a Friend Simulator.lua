-- GAME LINK: https://www.roblox.com/games/13748085494/FREE-UGC-Shoot-a-Friend-Simulator
-- UI LIBRARY
...
Tab:Button{
	...
	Description = nil,
	Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/0ShootFriend"))()
    end
}
-- CREDITS
GUI:Credit{
