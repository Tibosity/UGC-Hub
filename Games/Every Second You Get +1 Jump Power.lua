-- GAME LINK: https://www.roblox.com/games/11063612131/Every-Second-You-Get-1-Jump-Power
-- UI LIBRARY
...
Tab:Button{
	...
	Description = nil,
	Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/%2B1Jump"))()
    end
}
-- CREDITS
GUI:Credit{
