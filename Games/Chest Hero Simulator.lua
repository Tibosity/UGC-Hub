-- GAME LINK: https://www.roblox.com/games/14047294951/FREE-UGC-Chest-Hero-Simulator
-- UI LIBRARY
...
Tab:Button{
	...
	Description = nil,
	Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/0Chest"))()
    end
}
-- CREDITS
GUI:Credit{
