-- GAME LINK: https://www.roblox.com/games/14518789199/Obby-But-Youre-on-a-Pogo-Stick
-- UI LIBRARY
...
Tab:Button{
	...
	Description = nil,
	Callback = function()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/0ObbyPogo'))()
    end
}
-- CREDITS
GUI:Credit{
