-- GAME LINK: https://www.roblox.com/games/12888650105/Anime-Battlegrounds-Y
-- UI LIBRARY
...
Tab:Button{
	...
	Description = nil,
	Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/0AnimeY"))()
    end
}
-- CREDITS
GUI:Credit{
